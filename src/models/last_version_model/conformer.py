...
class Mlp(nn.Cell):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.drop = nn.Dropout(keep_prob=1 - drop)   # 1 or 0 ?
...
class Attention(nn.Cell):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.attn_drop = nn.Dropout(keep_prob=1 - attn_drop)  # strange ?
...
class Conformer(nn.Cell):
    ...
    def __init__(self, patch_size=16, in_chans=3, num_classes=1000, base_channel=64, channel_ratio=4, num_med_block=0,
                 ...
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.): # some different !
        # Transformer
        super().__init__()
        ...
        self.conv1 = nn.Conv2d(in_chans, 64, kernel_size=7, stride=2,  pad_mode='same',
                               has_bias=False)  # 1 / 2 [112, 112] padding: 0 -> 3 ;
    ...
    def construct(self, x):
        ...
        # conv classification
        x_p = ops.ReduceMean()(x, (2, 3))   # something different!
