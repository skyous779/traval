...
from src.tools.cell import cast_amp, InferenceCell
...
if __name__ == '__main__':
    ...
    inference_net = InferenceCell(network=net)
    input_arr = Tensor(np.zeros([1, 3, args.image_size, args.image_size], np.float32))
    export(inference_net, input_arr, file_name=args.arch, file_format=args.file_format)
